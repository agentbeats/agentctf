...
async def send_message(
    ...
    card = await get_agent_card(url)
    # Very long timeout for security tasks (includes Docker build + LLM calls + verification)
    httpx_client = httpx.AsyncClient(timeout=1200.0)  # 20 minutes
